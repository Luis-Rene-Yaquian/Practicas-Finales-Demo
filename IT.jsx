...
const technicalLanguages = [
  { id: "idioma1", name: "Idioma Técnico 1", icon: "📚" },
  { id: "idioma2", name: "Idioma Técnico 2", icon: "📖" },
  { id: "idioma3", name: "Idioma Técnico 3", icon: "📝" },
  { id: "idioma4", name: "Idioma Técnico 4", icon: "🎓" },
];
...
export default function TechnicalLanguagesPage() {
          ...
          <section className="relative h-[260px] w-full overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 h-full flex items-center">
              <div className="text-white">
                ...
                <h1 className="text-3xl md:text-4xl font-extrabold mt-1">Área de Idioma Técnico</h1>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border border-blue-200 rounded-2xl shadow-sm p-5">
                  ...
                  <div className="text-sm text-blue-900/90 space-y-1">
                    <p><span className="font-semibold">Oficina de Idioma Técnico</span></p>
